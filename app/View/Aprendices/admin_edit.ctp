...
<?php echo $this->Form->create('Aprendiz');?>
	<fieldset>
		<legend><?php echo __('Admin Edit Aprendiz'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Aprendiz.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Aprendiz.id'))); ?></li>
