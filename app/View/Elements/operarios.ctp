...
<tr>
	...
	<input name='data[Trabajador][<?php echo $i;?>][tra_fecha_ingreso]' type='date' class='date fecha_ingreso' id='Trabajador<?php echo $i;?>TraFechaIngreso' />
	</td>
	...
	<input name='data[Trabajador][<?php echo $i;?>][tra_fecha_nacimiento]' type='date' class='date fecha_nacimiento' id='Trabajador<?php echo $i;?>TraFechaNacimiento' />
	</td>
	<td><?php echo $this -> Form -> number('Trabajador.' . $i . '.tra_pago_mensual', array('label' => false, 'div' => false, 'class' => 'salarioOperarios valor'));?></td>
</tr>
<?php endfor;?>
