...
<table  border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <?php echo $inspeccion['Calificacion']['created']; ?> previo el estudio e informe de la Unidad de Inspección y Calificación de Talleres Artesanales de la Dirección Técnica, y de conformidad con los Arts. 5 
    del Reglamento de calificaciones y Ramas de Trabajos Vigentes <br>
    </span></td>
  </tr>
</table>
