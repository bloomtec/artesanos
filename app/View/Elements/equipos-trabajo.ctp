...
<tr>
	...
	<td>
		<?php echo $this -> Form -> date('EquiposDeTrabajo.'.$i.'.equ_fecha_de_adquisicion', array('label' => false, 'div' => false,'class' => 'date'));?> 
	...
	<td><?php echo $this -> Form -> input('EquiposDeTrabajo.'.$i.'.equ_valor_comercial', array('label' => false, 'div' => false, 'class' => 'valor_maquinas valor'));?></td>
</tr>
<?php endfor;?>