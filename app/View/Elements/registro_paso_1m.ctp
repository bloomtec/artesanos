<fieldset>
	<div class="Calificacion">
		...
		<div class="fila-datos validarCalificacion" row="0">
			...
			echo $this -> Form -> input('grupos_de_rama_id', array('label' => 'Grupo de rama:', 'col' => '1', 'options' => $grupos_de_ramas,'val'=>$calificacion['Rama']['grupos_de_rama_id']));
			echo $this -> Form -> input('Calificacion.rama_id', array('label' => 'Rama:', 'col' => '2', 'options' => array(),'val'=>$calificacion['Rama']['id']));
			echo $this -> Form -> hidden('Calificacion.id',array('value'=>$calificacion['Calificacion']['id']));
			?>
	...
	<div class="datos-personales validar tovalidate">
		...
		<div class="fila-datos" row="1">
			<?php
			echo $this -> Form -> input('DatosPersonal.id');
	...
	<div class="datos-taller validar tovalidate">
		...
		<div class="fila-datos" row="4">
			<?php
			echo $this -> Form -> input('Taller.id');
