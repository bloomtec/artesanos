...
<tr>
	...
	<td>
		<?php echo $this -> Form -> input('Trabajador.' . $i . '.tra_fecha_ingreso', array('label' => false, 'div' => false,'class' => 'date','type'=>'date','minYear'=>'1910'))?>
	...
	<td><?php echo $this -> Form -> number('Trabajador.' . $i . '.tra_pago_mensual', array('label' => false, 'div' => false, 'class' => 'salarioAprendiz'));?></td>
</tr>
<?php endfor;?>