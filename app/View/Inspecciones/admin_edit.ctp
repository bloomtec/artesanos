...
<?php echo $this->Form->create('Inspeccion');?>
	<fieldset>
		<legend><?php echo __('Admin Edit Inspeccion'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Inspeccion.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Inspeccion.id'))); ?></li>
