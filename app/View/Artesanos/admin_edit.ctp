...
<?php echo $this->Form->create('Artesano');?>
	<fieldset>
		<legend><?php echo __('Admin Edit Artesano'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Artesano.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Artesano.id'))); ?></li>
