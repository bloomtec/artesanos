...
<table border="0"  cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="160" ><div style="text-align: left; font-size:38px; border-bottom: 1px solid black; text-align: center;"><?php print($fecha2.' '.$fecha[2]); ?></div></td>
		<td width="150" ><div style="text-align: center; font-size:38px;"><b>Con una duracion de:</b></div></td>
		<td width="40" ><div style="text-align: left; font-size:38px; border-bottom: 1px solid black; text-align: center;"><?php echo print($alumno["Curso"]["cur_numero_horas"]); ?></div></td>
