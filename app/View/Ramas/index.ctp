<div class="ramas index">
	...
	<tr>
		<td><?php echo h($rama['Rama']['id']); ?>&nbsp;</td>
		<td><?php echo h($rama['Rama']['nombre']); ?>&nbsp;</td>
		<td><?php echo h($rama['Rama']['descripcion']); ?>&nbsp;</td>
		<td><?php echo h($rama['Rama']['created']); ?>&nbsp;</td>
		<td><?php echo h($rama['Rama']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $rama['Rama']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $rama['Rama']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $rama['Rama']['id']), null, __('Are you sure you want to delete # %s?', $rama['Rama']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
