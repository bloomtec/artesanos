...
<?php echo $this->Form->create('Balance');?>
	<fieldset>
		<legend><?php echo __('Admin Edit Balance'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Balance.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Balance.id'))); ?></li>
