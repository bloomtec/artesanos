...
<div class="reportes form">
	...
	<fieldset>
		<?php
		echo $this -> Form -> input('rama', array('type' => 'select', 'label' => 'Titulos', 'empty' => 'Seleccione...', 'options' => $titulos));
		echo $this -> Form -> input('titulo', array('type' => 'select', 'label' => 'Juntas provinciales', 'empty' => 'Seleccione...', 'options' => $juntasProvinciales));
		echo $this -> Form -> input('titulo', array('type' => 'select', 'label' => 'Tipo especie valorada', 'empty' => 'Seleccione...', 'options' => $especiesValoradas));
