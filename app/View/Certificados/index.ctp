<div class="certificados index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $certificado['Certificado']['id']), null, __('Are you sure you want to delete # %s?', $certificado['Certificado']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
