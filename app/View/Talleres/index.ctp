<div class="talleres index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($taller['Provincia']['id'], array('controller' => 'provincias', 'action' => 'view', $taller['Provincia']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($taller['Canton']['id'], array('controller' => 'cantones', 'action' => 'view', $taller['Canton']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($taller['Ciudad']['id'], array('controller' => 'ciudades', 'action' => 'view', $taller['Ciudad']['id'])); ?>
		</td>
		<td>
