...
<?php echo $this->Form->create('Taller');?>
	<fieldset>
		<legend><?php echo __('Admin Edit Taller'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Taller.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Taller.id'))); ?></li>
