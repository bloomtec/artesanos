...
<h2><?php  echo __('Taller');?></h2>
	<dl>
		...
		<dd>
			<?php echo h($taller['Taller']['created']); ?>
			&nbsp;
		</dd>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Taller'), array('action' => 'edit', $taller['Taller']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Taller'), array('action' => 'delete', $taller['Taller']['id']), null, __('Are you sure you want to delete # %s?', $taller['Taller']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Talleres'), array('action' => 'index')); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($taller['Aprendiz'] as $aprendiz): ?>
		<tr>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($taller['Balance'] as $balance): ?>
		<tr>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($taller['Equipo'] as $equipo): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($taller['Inspeccion'])):?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
	...
	<?php
		$i = 0;
		foreach ($taller['Inspeccion'] as $inspeccion): ?>
		<tr>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($taller['Material'] as $material): ?>
		<tr>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($taller['Producto'] as $producto): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($taller['Trabajador'])):?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Operario'); ?></th>
	...
	<?php
		$i = 0;
		foreach ($taller['Trabajador'] as $trabajador): ?>
		<tr>
