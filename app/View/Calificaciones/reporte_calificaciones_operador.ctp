<div class=" informe">
	<table>
		...
		<tr>
			...
			<td class='actions'>
				<?php 
					if($calificacion['Calificacion']['cal_estado']==1) echo $this -> Html -> link('Especie Valorada',array("action"=>"imprimir",$calificacion['Calificacion']['id']),array('target'=>'blank_', 'class'=>'button','title'=>'Especie Valorada')); 
