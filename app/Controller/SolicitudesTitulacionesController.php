...
class SolicitudesTitulacionesController extends AppController {
	...
	/**
	 * Listar solicitudes de titulaciones
	 *
	 * @return void
	 */
	...
	/**
	 * Ver una solicitud de titulación
	 *
	 * @param int $id ID de la solicitud de titulación que se desea ver
	 * @return void
	 */
	...
	/**
	 * Limpiar el directorio de archivos dejando solo aquellos que esten en la base de datos
	 * 
	 * @return void
	 */
	...
	/**
	 * Agregar una solicitud de titulación
	 *
	 * @return void
	 */
	public function add() {
	...
	/**
	 * Eliminar una solicitud de titulación
	 *
	 * @param int $id ID de la solicitud que se quiere eliminar
	 * @return void
	 */
	...
	/**
	 * Revisar la solicitud para ver si se aprueba o no 
	 *
	...
	/**
	 * Reporte de solicitudes de titulación
	 * 
	 * @return void
	 */
	...
	/**
	 * Refrendar una titulación
	 * 
	 * @param int $idSolicitudTitulacion ID de la solicitud de titulación que se va a refrendar
	 * 
	 * @return void
	 */
